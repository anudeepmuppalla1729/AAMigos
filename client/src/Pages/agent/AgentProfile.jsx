...
function AgentProfilePage() {
  ...
  return (
      <div className='bg-[#0d1117] h-screen w-screen flex flex-wrap'>
        ...
        <div className='bg-[#0d1117] h-[88%] w-[20%] flex justify-center pl-7 items-center pt-[2%]'><AgentSidebar/></div>
        <div className='h-[90%] w-[80vw] flex flex-col items-center text-white justify-evenly'>
            <div>
              ...
              <img src={agent.profilePic} alt="profile pic" className={"size-20 ml-2"}/>
            </div>
          <div className={"flex justify-end w-full pr-9 translate-y-3 mr-48 mb-4  "}>
          ...
          <div className={"flex flex-col justify-evenly"}>
            <div className={"bg-[#ffffff]/5 w-[65vw] min-h flex flex-col justify-center rounded-2xl mr-15 mb-2"}>
              <div className={"pl-4 text-xs p-4"}>
                <h3 className={"underline text-sm font-[600] pb-2"}>Agent Details</h3>
              ...
              " mt-2"}>
              <div className={"pl-4 text-xs p-4"}>
                <h3 className={"underline text-sm font-[600] pb-2"}>Address Details</h3>
