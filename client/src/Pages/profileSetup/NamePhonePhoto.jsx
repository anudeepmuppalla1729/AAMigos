...
//     console.log(currentStep)
//     // Validation for step 3 if user is an agent
//     if (isAgent && currentStep === 0 && (!panCard || !adhaarNumber)) {
...
//         ? "http://localhost:3000/api/setup/agent/setupProfile" 
//         : "http://localhost:3000/api/setup/user/setupProfile");
//       console.log(isAgent)
...
//             {isAgent && (
//               <>
//                 <div className={`h-[2px] w-4 ${currentStep >= 3 ? 'bg-[#BF400A]' : 'bg-gray-600'}`}></div>
//                 <div className={`h-2 w-2 rounded-full ${currentStep >= 3 ? 'bg-[#BF400A]' : 'bg-gray-600'}`}></div>
//               </>
//             )}
//           </div>
//         </div>
...
//           </form>
//         ) : (
//           // Step 3: Agent Details (Only shown if isAgent is true)
//           <form onSubmit={handleSubmit} className='flex flex-col items-center gap-6 mt-8'>
//             <h2 className="text-xl font-semibold mb-2">Agent Verification</h2>
//             <div className='w-full max-w-[400px] space-y-4'>
//               <div className='flex flex-col space-y-2'>
//                 <label htmlFor={"adhaarInput"} className='text-sm text-gray-300'>Aadhaar Number</label>
//                 <input 
//                   type="text" 
//                   id={"adhaarInput"} 
//                   value={adhaarNumber}
...
//               <div className='flex flex-col space-y-2'>
//                 <label htmlFor={"panInput"} className='text-sm text-gray-300'>PAN Card Number</label>
//                 <input 
//                   type="text" 
//                   id={"panInput"} 
//                   value={panCard}
