  ...
  return (
        <div className="w-full md:w-auto h-[10%] bg-[#171925] flex justify-between pr-10">
          ...
          <input type="text" placeholder={"Search..."} className={"mr-[3vh] mt-[2vh] mb-[3vh] ml-[15vh] w-[50vh]" +
            ...
            <div className='flex '>
          { !isAgent ? (<button onClick={handleNewOrder} className={"rounded-2xl text-white bg-[#FF4E00] h-[5vh] w-[18vh] mt-[7%] ml-[17%] hover:scale-105 hover:shadow-lg hover:shadow-[#ffffff]/1 transition-all duration-300 ease-in-out" +
